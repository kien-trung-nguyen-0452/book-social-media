...
public enum ErrorCode {
    ...
    INTERNAL_ERROR(4999, "Internal server error", HttpStatus.INTERNAL_SERVER_ERROR),USER_PROFILE_DELETE_FAILED(1010, "User profile delete failed", HttpStatus.INTERNAL_SERVER_ERROR),
    ...
    INVALID_CURRENT_PASSWORD(1010, "wrong password", HttpStatus.BAD_REQUEST);
